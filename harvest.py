...
def make_melon_type_lookup(melon_types):
    """Take a list of MelonTypes and return a dictionary of melon types by code."""
    melons_by_code = {}
    for melon in melon_types:
...
melon_lookup = make_melon_type_lookup(all_melon_types)
...
class Melon:
    ...
    def __init__(
        self, melon_type, shape_rating, color_rating, field, harvest_name
...
def make_melon_type_lookup(melon_types):
    """Returns a dictionary of melon types."""
    melons_by_id = {}
    for melon_id, melon_data in melon_types.items():
        melons_by_id[melon_id] = melon_data[0]
    return melons_by_id
...
def make_melons(melon_types):
    ...
    melon_6 = Melon(melons_by_id['cren'], 8, 9, 35, 'Michael')
...
def get_sellability_report(melons):
    ...
    for melon in melons:
        harvested_by = f"Harvested by {melon.harvest_name}"
